        ...
        <div className='flex md:flex-row flex-col gap-3'>
            <div className='flex flex-col gap-2 md:w-2/3'>
                <a 
                    ...
                    target="_blank"
                    rel="noreferrer">
                    <div style={{ backgroundImage: `url(${videos[0]?.imageUrl})`}} className={`bg-cover bg-no-repeat bg-center md:h-96 h-48 flex justify-center items-center`}>
            ...
            <div className='flex flex-col gap-4 md:w-1/3'>
                        ...
                        <div key={video?._id} className='flex flex-row gap-2'>
                            ...
                            <div className='w-1/2 pt-2'>
                                <a 
                                    ...
                                    target="_blank"
                                    rel="noreferrer"         
                                    className='lg:text-sm text-xs leading-4 font-bold'>{video?.title}</a>
                            </div>
                        </div>
                    ))}
                </div>
                <div className='flex justify-end'>
                    <div className='flex flex-row gap-2 items-center'>
                        <NavLink to={'/category/videos'} className='uppercase font-semibold md:text-xl text-base'>toutes les vidéos</NavLink>
